    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ justifyContent: 'center', alignItems: 'center', paddingTop: 10,backgroundColor:'blue' }}>
                    <Text style={{ fontSize: 15 }}>I am Looking for technology</Text>
                </View>
                <View style={{ paddingTop: 15, flex: 8,backgroundColor:'yellow' }}>
                    <SectionList
